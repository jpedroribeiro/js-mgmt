...
System.register("js_jspm/myModule", [], function (_export) {
	var myModule;
	return {
		setters: [],
		execute: function () {
			...
			_export("myModule", myModule);
		}
	};
});
System.register("js_jspm/main", ["js_jspm/myModule", "github:components/jquery@2.1.3"], function (_export) {
	var myModule, $;
	return {
		setters: [function (_js_jspmMyModule) {
			myModule = _js_jspmMyModule.myModule;
